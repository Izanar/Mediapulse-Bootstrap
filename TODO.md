...
- [x] 1.4. База данных и миграции:
  - [x] Разворачивание PostgreSQL в Docker.
...
- [х] 1.7. Модуль авторизации (JWT, регистрация, вход, разграничение прав `is_public` / `private`).
...
- [ ] 1.10. Упаковка в контейнеры (`Dockerfile.api` и `Dockerfile.worker` на `python:3.12-slim`).
- [ ] 1.11. Сквозное локальное тестирование всех эндпоинтов.
