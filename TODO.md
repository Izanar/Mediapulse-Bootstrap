...
- [ ] **1.10. Галерея, Права доступа и Стандартизация (Ветка `feature/gallery-and-privacy`):**
  - [x] Стандартизация именования файлов в S3 (единый паттерн с датой, UUID и суффиксами).
  - [x] Эндпоинт и логика переключения видимости файлов (`is_public`: `true`/`false`).
